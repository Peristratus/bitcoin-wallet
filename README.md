...
Login | L-6.0 | Gain access to login section| **As a** user **I want** to access the Login Modal form of Bitquest **so that** I can gain access to the Login information.| **Given** that the user is on the Bitquest platform, **When** they click on the Login nav link **then** the system  will scroll to the login button,once the user clicks on it, the modal login form will appear and accept/ validte the users input .|    M   |
Signup | S-7.0 | Gain accessto Signup section| **As a** user **I want** to access the signup section of Bitquest **so that** I can gain access to the Signup information to signup.| **Given** that the user is on the Bitquest platform, **When** they click on the signup Nav link **then** the system  will go to the signup section, the form will accept and validte the users information before and after the user clicks on the submit button  |    M   |
Signup | S-7.1 | Gain accessto Signup section| **As a** user **I want** to access the signup section of Bitquest **so that** I can gain access to the Signup information to signup.| **Given** that the user is on the Bitquest platform, **When** they click on the signup button **then** the system  will go to the signup section, the form will accept and validte the users information before and after the user clicks on the submit button . |    M   |

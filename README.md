...
APT-SCB-4.2 | C-4.2            | Subscribe button                  | APT-SCB-4.2.1: Click Subscribe buttom| The button should be funtional and allow the user to Subscribe                                                                                                                                                                                                 |                     Fail: Low defect be functional in phase 2 development |
